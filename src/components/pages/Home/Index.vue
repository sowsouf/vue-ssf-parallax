<template>
  <div class="home">
    ...
    <ssf-parallax image="https://www.visitportugal.com/sites/www.visitportugal.com/files/mediateca/23_660x371.jpg">
      <template slot="overlay-content">Heeeeeeey</template>
    </ssf-parallax>
...
<script>
  ...
  import SsfParallax from "../../SsfParallax/components/Main";

  export default {

    name: 'Home',

    components: { SsfParallax },
